...
## How to install (DEFAULT or BASIC USAGE)
	* git clone https://github.com/lxlenaux/tokpa.git
	* cd bot-igeh
...
## For PC/Laptop ONLY:
	...
	* Download File on Github (https://github.com/lxlenaux/tokpa.git)
	* Extract File tokpa and enter the folder
	* Right Click on Mouse, Then Select "Git Bash Here" (Make sure you are in the bot-igeh folder!!!)
	* Then type: unzip node_modules.zip
	* npm install https://github.com/dilame/instagram-private-api
	* npm audit fix
